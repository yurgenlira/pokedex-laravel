...
- **CI/CD:**
    - Refactored the GitHub Actions workflow to use a composite action for setting up the Laravel environment.
    - Added documentation for running the CI/CD pipeline locally using `act`.
